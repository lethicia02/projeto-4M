...
let sair = "Voce nao quis participar. Obrigado pela sua resposta!";
    ...
    else{ window.alert('Começou o Vestibular! Clique em Ok abaixo para começar (Responda utilizando somento números)');
//Inicio do quiz
...
let p = new Array();
let r = new Array();
let t=3; //TOTAL DE PERGUNTAS DO QUIZ!
// LISTA DE PERGUNTAS
    p[1] = "Quanto é 100/5? \n a:) 20 \n b:)30 \n c:)40 ";
    r[1] = 20;
